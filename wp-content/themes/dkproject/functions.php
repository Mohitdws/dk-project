...
function add_css()
{
   wp_register_style( 'bootstrap-css', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '1.0', 'all' );
	...
	wp_register_style( 'owlcarousel-style', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css', array(), '1.0', 'all' );
	wp_enqueue_style( 'owlcarousel-style' );
	
	wp_register_style( 'owl-theme-style', get_stylesheet_directory_uri() . '/assets/css/owl.theme.default.min.css', array(), '1.0', 'all' );
	wp_enqueue_style( 'owl-theme-style' );
	
	wp_register_style( 'main-style', get_stylesheet_directory_uri() . '/assets/css/style.css', array(), '1.0', 'all' );
...
function add_script()
{
   wp_register_script('js-script', get_template_directory_uri() . '/assets/js/bootstrap.bundle.min.js', array ( 'jquery' ), 1.1, true);
   wp_enqueue_script( 'js-script');
   wp_register_script('change', get_template_directory_uri() . '/assets/js/jquery.min.js', array ( 'jquery' ), 1.1, true);
   wp_enqueue_script( 'change');
   wp_register_script('popup', get_template_directory_uri() . '/assets/js/jquery.validate.min.js', array ( 'jquery' ), 1.1, true);
   wp_enqueue_script( 'popup');
   wp_register_script('carousel', get_template_directory_uri() . '/assets/js/owl.carousel.js', array ( 'jquery' ), 1.1, true);
   wp_enqueue_script( 'carousel');
   wp_register_script('bootstrap', get_template_directory_uri() . '/assets/js/custom.js', array ( 'jquery' ), 1.1, true);
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description'         => __( 'Service', 'twentytwentyone' ),
        'labels'              => $labels,
...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Testimonials', 'Post Type General Name', 'twentytwentyone' ),
        'singular_name'       => _x( 'Testimonial', 'Post Type Singular Name', 'twentytwentyone' ),
        'menu_name'           => __( 'Testimonials', 'twentytwentyone' ),
        'parent_item_colon'   => __( 'Parent Testimonial', 'twentytwentyone' ),
        'all_items'           => __( 'All Testimonials', 'twentytwentyone' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description'         => __( 'Testimonials', 'twentytwentyone' ),
        'labels'              => $labels,
        // Features this CPT supports in Post Editor
        'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
        // You can associate this CPT with a taxonomy or custom taxonomy. 
